...
_G.packer_plugins = {
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/qvieth/.local/share/lunarvim/site/pack/packer/opt/nvcode-color-schemes.vim"
  },
  ["nvim-autopairs"] = {
  ...
  ["zen-mode.nvim"] = {
    commands = { "ZenMode" },
    config = { "\27LJ\2\2“\1\0\0\3\0\b\0\0206\0\0\0'\1\1\0B\0\2\0029\0\2\0B\0\1\0016\0\3\0009\0\4\0009\0\5\0009\0\6\0\15\0\0\0X\1\b€6\0\3\0009\0\4\0009\0\5\0009\0\6\0006\1\0\0'\2\a\0B\1\2\0A\0\0\1K\0\1\0\rzen-mode\19on_config_done\bzen\vplugin\6O\nsetup\rcore.zen\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType typescript.tsx ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "typescript.tsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascriptreact ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "javascriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescriptreact ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "typescriptreact" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript.jsx ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'nvim-lsp-ts-utils', 'emmet-vim', 'nvim-ts-autotag'}, { ft = "javascript.jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType elixir ++once lua require("packer.load")({'vim-elixir'}, { ft = "elixir" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-commentary', 'vim-surround', 'nvim-comment', 'zen-mode.nvim', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-lspinstall'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'galaxyline.nvim', 'rnvimr', 'nvim-toggleterm.lua', 'dashboard-nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vscode-es7-javascript-react-snippets', 'friendly-snippets', 'emmet-vim', 'vim-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
